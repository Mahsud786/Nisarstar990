#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To NisarTech
...
print  """
 \033[1;91m ♦♦♦———————————————————————————————♦♦♦                            
\033[1;94m  Nisar Mahsud 
\033[1;95m   termux master 
\033[1;97m   cp idz 7 din bad open hoti ha 
 \033[1;91m ♦♦♦———————————————————————————————♦♦♦               
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:Nisar Mahsud
	    time.sleep(2)
            loop = 'false'
        else:
...
def pilih_super():
	...
	if peak =="":
		...
		print logo
		jalan('\033[1;94m[+]\033[1;95mUsman█████████████████▒▒▒▒▒▒▒▒..99%\033[1;95m:-:')
	...
	p.map(main, id)
#Dev: Nisar-TECH
        print "\033[1;95m•-----------------\033[1;35m👺Nisar Mahsud\033[1;95m-----------------•"
